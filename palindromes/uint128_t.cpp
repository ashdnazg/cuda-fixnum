...
uint128_t uint128_t::operator&(uint128_t rhs) const{
...
bool uint128_t::operator&&(uint128_t rhs) const{
...
std::pair <uint128_t, uint128_t> uint128_t::divmod(uint128_t lhs, const uint128_t & rhs) const{
