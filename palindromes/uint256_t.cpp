...
constexpr uint256_t uint256_max(uint128_t((uint64_t) -1, (uint64_t) -1), uint128_t((uint64_t) -1, (uint64_t) -1));
...
uint256_t uint256_t::operator&(uint256_t rhs) const{
...
uint256_t & uint256_t::operator<<=(uint256_t shift){
    *this = *this << shift;
    return *this;
}
...
bool uint256_t::operator&&(uint256_t rhs) const{
...
std::pair <uint256_t, uint256_t> uint256_t::divmod(uint256_t lhs, const uint256_t & rhs) const{
